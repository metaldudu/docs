...
# https://api.douban.com/v2/book/user/metaldudu/collections?status=read&from=2019-01-01T00:00:00+08:00&to=2019-01-02T00:00:00+08:00&apikey=0df993c66c0c636e29ecbb5344252a4a
# 标准地址。20190704更新APIkey
...
while m <= 12:
	try:
		...
		html = 'https://api.douban.com/v2/book/user/' + USERNAME + '/collections?status=read&from=' + thismonth + 'T00:00:00+08:00&to=' + nextmonth + 'T00:00:00+08:00'+ '&apikey=0df993c66c0c636e29ecbb5344252a4a'
		# 构造api地址
...
# 输出年度数量
html2 = 'https://api.douban.com/v2/book/user/' + USERNAME + '/collections?status=read&from=' + YEAR + '-01-01T00:00:00+08:00&to=' + str(int(YEAR)+1) + '-01-01T00:00:00+08:00'+ '&apikey=0df993c66c0c636e29ecbb5344252a4a'
