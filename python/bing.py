...
rssurl = 'http://www2.bing.com/HPImageArchive.aspx?format=rss&idx=0&n=1&mkt=en-US'
# 官方rss源
...
wpurl = wpurl[ps1:ps2]
wpurl = 'http://www2.bing.com' + wpurl
print (wpurl)
...
# mate desktop
cmd3 = 'dconf write /org/mate/desktop/background/picture-filename \'\"/home/laodu/documents/bash/' + day + '.jpg\"\'' 
os.system(cmd3)
